...
namespace SimpleAsyncClient
{
    public class AsyncClient : IAsyncClient
    {
        ...
        public async Task<TResponse> Send<TRequest, TResponse>(TRequest request, HttpMethod httpMethod, string requestUri) where TRequest : class where TResponse : class
        {
        ...
        public async Task<TResponse> Post<TRequest, TResponse>(TRequest request, string requestUri, string fileName, Stream stream) where TRequest : class where TResponse : class
        {
